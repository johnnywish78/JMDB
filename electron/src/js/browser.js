...
window.BrowserHub = (function () {
  ...
  function render() {
    ...
    const newBtn = el("button", "browser-btn browser-btn-small browser-btn-ghost", "\uFF0B");
    ...
    const mkBtn = (label, title, fn) => {
      const b = el("button", "browser-btn browser-btn-small browser-btn-ghost", label);
      b.title = title;
    ...
    // pin button
    const pinBtn = el("button", "browser-btn browser-btn-small" + (active && active.pinned ? "" : " ghost"), "\u2605");
    ...
    loadFavorites().then((favs) => {
      favs.forEach((f) => {
        const chip = el("button", "browser-btn browser-btn-small browser-btn-chip", "\u2605 " + (f.name || f.url));
        chip.title = f.url;
  ...
  function showPermissionDialog(data) {
    ...
    const denyBtn = el("button", "browser-btn browser-btn-small", "Deny");
    const allowBtn = el("button", "browser-btn browser-btn-small browser-btn-primary", "Allow");
