...
window.BrowserSettings = (function () {
  ...
  function renderAbout(p) {
    section(p, "About");
    p.appendChild(h("p", "", "JMDB — Johnny's Media Database"));
    p.appendChild(h("p", "muted", "Version 1.0.0"));
    ...
    ["Homepage", "Report issue"].forEach(function (label, i) {
      var url = ["https://github.com/johnnywish78/JMDB", "https://github.com/johnnywish78/JMDB/issues"][i];
